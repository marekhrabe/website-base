module.exports = function (grunt) {
    ...
    grunt.registerTask('index', 'Process index.html', function () {
        grunt.file.write('index.html', grunt.template.process(grunt.file.read('src/index.html')));
    });

    grunt.registerTask('jsTemplates', 'Process app.js', function () {
        grunt.file.write('dist/app.js', grunt.template.process(grunt.file.read('dist/app.js')));
    });
    ...
    grunt.registerTask('js', ['uglify:app', 'jsTemplates']);
};
